...
Discretizamos cuando tiene sentido y en función de cada variable. (**CAMBIO P1**: Actualizar para incluir en las columnas a discretizar "Sex" y "Embarked" - prueba para git).
