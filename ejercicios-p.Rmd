...
author: "Gerardo Adrián Aguirre Vivar & demás"
...
Se realiza un histograma de todas las filas de la variable lifetime para comprobar que efectivamente nos interesa separar los datos.
...
~Aquí debemos añadir una explicación de porque con la gráfica que sale debemos saber que se trata de dos conjuntos de datos~

---

Se crean dos data.frames para los dos conjuntos de datos que existen
...
Ahora se procede a realizar un histograma de cada uno de los tipos de baterías para comprobar que efectivamente ambos subconjuntos siguen una distribución normal
...
~Decir que la curva (en discontinuo tiene la forma de una normal, pero para estar más seguro luego se calcula un p-valor)~

---

Además, para confirma nuestras suposiciones se procede a realizar un test de normalidad y un gráfico Quantil-Quantil.

Si establecemos que:

$H_0:$ Los datos de A/B siguen una distribución normal

$H_1:$ Los datos de A/B no siguen una distribución normal
