...
```{r warning=FALSE}
#---------------------------------------------------------------------------------------------------------------------------------------------
kable(c(summary(datos$Number.of.bedrooms))) %>%
  kable_styling() %>%
  scroll_box(width = "100%", height = "100%")

#---------------------------------------------------------------------------------------------------------------------------------------------
kable(c(summary(datos$Number.of.Refrigerator.Freezer))) %>%
  kable_styling() %>%
  scroll_box(width = "100%", height = "100%")

#---------------------------------------------------------------------------------------------------------------------------------------------
kable(c(summary(datos$Number.of.Washing.Machine))) %>%
  kable_styling() %>%
  scroll_box(width = "100%", height = "100%")

#---------------------------------------------------------------------------------------------------------------------------------------------
kable(c(summary(datos$Number.of.Airconditioner))) %>%
  kable_styling() %>%
  scroll_box(width = "100%", height = "100%")

#---------------------------------------------------------------------------------------------------------------------------------------------
kable(c(summary(datos$Number.of.Car..Jeep..Van))) %>%
  kable_styling() %>%
  scroll_box(width = "100%", height = "100%")

#---------------------------------------------------------------------------------------------------------------------------------------------
kable(c(summary(datos$Number.of.CD.VCD.DVD))) %>%
  kable_styling() %>%
  scroll_box(width = "100%", height = "100%")

#---------------------------------------------------------------------------------------------------------------------------------------------
kable(c(summary(datos$Number.of.Cellular.phone))) %>%
  kable_styling() %>%
  scroll_box(width = "100%", height = "100%")

#---------------------------------------------------------------------------------------------------------------------------------------------
kable(c(summary(datos$Number.of.Component.Stereo.set))) %>%
  kable_styling() %>%
  scroll_box(width = "100%", height = "100%")

#---------------------------------------------------------------------------------------------------------------------------------------------
kable(c(summary(datos$Number.of.Landline.wireless.telephones))) %>%
  kable_styling() %>%
  scroll_box(width = "100%", height = "100%")

#---------------------------------------------------------------------------------------------------------------------------------------------
kable(c(summary(datos$Number.of.Personal.Computer))) %>%
  kable_styling() %>%
  scroll_box(width = "100%", height = "100%")

#---------------------------------------------------------------------------------------------------------------------------------------------
kable(c(summary(datos$Number.of.Motorcycle.Tricycle))) %>%
  kable_styling() %>%
  scroll_box(width = "100%", height = "100%")

#---------------------------------------------------------------------------------------------------------------------------------------------
kable(c(summary(datos$Number.of.Stove.with.Oven.Gas.Range))) %>%
  kable_styling() %>%
  scroll_box(width = "100%", height = "100%")

#---------------------------------------------------------------------------------------------------------------------------------------------
kable(c(summary(datos$Number.of.Television))) %>%
  kable_styling() %>%
  scroll_box(width = "100%", height = "100%")

#---------------------------------------------------------------------------------------------------------------------------------------------
kable(c(summary(datos$Number.of.Motorized.Banca))) %>%
  kable_styling() %>%
  scroll_box(width = "100%", height = "100%")
...
kable(c(summary(var_train_num$Total.Household.Income))) %>%
  kable_styling() %>%
  scroll_box(width = "100%", height = "100%")

kable(c(summary(var_train_num$Total.Food.Expenditure))) %>%
  kable_styling() %>%
  scroll_box(width = "100%", height = "100%")

kable(c(summary(var_train_num$Bread.and.Cereals.Expenditure))) %>%
  kable_styling() %>%
  scroll_box(width = "100%", height = "100%")

kable(c(summary(var_train_num$Total.Rice.Expenditure))) %>%
  kable_styling() %>%
  scroll_box(width = "100%", height = "100%")

kable(c(summary(var_train_num$Meat.Expenditure))) %>%
  kable_styling() %>%
  scroll_box(width = "100%", height = "100%")

kable(c(summary(var_train_num$Total.Fish.and..marine.products.Expenditure))) %>%
  kable_styling() %>%
  scroll_box(width = "100%", height = "100%")
...
kable(c(summary(var_train_num$Fruit.Expenditure))) %>%
  kable_styling() %>%
  scroll_box(width = "100%", height = "100%")

kable(c(summary(var_train_num$Vegetables.Expenditure))) %>%
  kable_styling() %>%
  scroll_box(width = "100%", height = "100%")

kable(c(summary(var_train_num$Restaurant.and.hotels.Expenditure))) %>%
  kable_styling() %>%
  scroll_box(width = "100%", height = "100%")

kable(c(summary(var_train_num$Alcoholic.Beverages.Expenditure))) %>%
  kable_styling() %>%
  scroll_box(width = "100%", height = "100%")

kable(c(summary(var_train_num$Tobacco.Expenditure))) %>%
  kable_styling() %>%
  scroll_box(width = "100%", height = "100%")

kable(c(summary(var_train_num$Clothing..Footwear.and.Other.Wear.Expenditure))) %>%
  kable_styling() %>%
  scroll_box(width = "100%", height = "100%")
...
kable(c(summary(var_train_num$Housing.and.water.Expenditure))) %>%
  kable_styling() %>%
  scroll_box(width = "100%", height = "100%")

kable(c(summary(var_train_num$Imputed.House.Rental.Value))) %>%
  kable_styling() %>%
  scroll_box(width = "100%", height = "100%")

kable(c(summary(var_train_num$Medical.Care.Expenditure))) %>%
  kable_styling() %>%
  scroll_box(width = "100%", height = "100%")

kable(c(summary(var_train_num$Transportation.Expenditure))) %>%
  kable_styling() %>%
  scroll_box(width = "100%", height = "100%")

kable(c(summary(var_train_num$Communication.Expenditure))) %>%
  kable_styling() %>%
  scroll_box(width = "100%", height = "100%")

kable(c(summary(var_train_num$Education.Expenditure))) %>%
  kable_styling() %>%
  scroll_box(width = "100%", height = "100%")
...
kable(c(summary(var_train_num$Miscellaneous.Goods.and.Services.Expenditure))) %>%
  kable_styling() %>%
  scroll_box(width = "100%", height = "100%")


kable(c(summary(var_train_num$Special.Occasions.Expenditure))) %>%
  kable_styling() %>%
  scroll_box(width = "100%", height = "100%")


kable(c(summary(var_train_num$Crop.Farming.and.Gardening.expenses))) %>%
  kable_styling() %>%
  scroll_box(width = "100%", height = "100%")


kable(c(summary(var_train_num$Total.Income.from.Entrepreneurial.Acitivites))) %>%
  kable_styling() %>%
  scroll_box(width = "100%", height = "100%")


kable(c(summary(var_train_num$Household.Head.Age))) %>%
  kable_styling() %>%
  scroll_box(width = "100%", height = "100%")


kable(c(summary(var_train_num$Total.Number.of.Family.members))) %>%
  kable_styling() %>%
  scroll_box(width = "100%", height = "100%")
...
kable(c(summary(var_train_num$Total.number.of.family.members.employed))) %>%
  kable_styling() %>%
  scroll_box(width = "100%", height = "100%")
  
kable(c(summary(var_train_num$House.Floor.Area))) %>%
  kable_styling() %>%
  scroll_box(width = "100%", height = "100%")
  
kable(c(summary(var_train_num$House.Age))) %>%
  kable_styling() %>%
  scroll_box(width = "100%", height = "100%")
  
kable(c(summary(var_train_num$Number.of.bedrooms))) %>%
  kable_styling() %>%
  scroll_box(width = "100%", height = "100%")
  
kable(c(summary(var_train_num$Number.of.Television))) %>%
  kable_styling() %>%
  scroll_box(width = "100%", height = "100%")
  
kable(c(summary(var_train_num$Number.of.CD.VCD.DVD))) %>%
  kable_styling() %>%
  scroll_box(width = "100%", height = "100%")
...
kable(c(summary(var_train_num$Number.of.Component.Stereo.set))) %>%
  kable_styling() %>%
  scroll_box(width = "100%", height = "100%")
  
kable(c(summary(var_train_num$Number.of.Refrigerator.Freezer))) %>%
  kable_styling() %>%
  scroll_box(width = "100%", height = "100%")
  
kable(c(summary(var_train_num$Number.of.Washing.Machine))) %>%
  kable_styling() %>%
  scroll_box(width = "100%", height = "100%")
  
kable(c(summary(var_train_num$Number.of.Airconditioner))) %>%
  kable_styling() %>%
  scroll_box(width = "100%", height = "100%")
  
kable(c(summary(var_train_num$Number.of.Car..Jeep..Van))) %>%
  kable_styling() %>%
  scroll_box(width = "100%", height = "100%")
  
kable(c(summary(var_train_num$Number.of.Landline.wireless.telephones))) %>%
  kable_styling() %>%
  scroll_box(width = "100%", height = "100%")
...
kable(c(summary(var_train_num$Number.of.Cellular.phone))) %>%
  kable_styling() %>%
  scroll_box(width = "100%", height = "100%")
  
kable(c(summary(var_train_num$Number.of.Personal.Computer))) %>%
  kable_styling() %>%
  scroll_box(width = "100%", height = "100%")

kable(c(summary(var_train_num$Number.of.Stove.with.Oven.Gas.Range))) %>%
  kable_styling() %>%
  scroll_box(width = "100%", height = "100%")
  
kable(c(summary(var_train_num$Number.of.Motorized.Banca))) %>%
  kable_styling() %>%
  scroll_box(width = "100%", height = "100%")
  
kable(c(summary(var_train_num$Number.of.Motorcycle.Tricycle))) %>%
  kable_styling() %>%
  scroll_box(width = "100%", height = "100%")
...
kable(c(summary(datos_training$Total.Household.Income))) %>%
  kable_styling() %>%
  scroll_box(width = "100%", height = "100%")
...
Llegados hasta este punto, resulta interesante mostrar el gráfico Q-Q, histograma y test de normalidad para los resudios en unidades normales y en unidades logaritmicas obtenidos en la predicción
