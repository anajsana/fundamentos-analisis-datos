...
kable(summary(datos$Main.Source.of.Income)) %>%
  kable_styling() %>%
  scroll_box(width = "100%", height = "100%")summary(datos$Main.Source.of.Income)
...
datos$Main.Source.of.Income = factor(datos$Main.Source.of.Income,ordered=TRUE,levels=(c('Other sources of Income'
                                                                            ...
                                                                            , 'Wage/Salaries')))
kable(levels(datos$Main.Source.of.Income)) %>%
  kable_styling() %>%
  scroll_box(width = "100%", height = "100%")
...
kable(summary(datos$Household.Head.Marital.Status)) %>%
  kable_styling() %>%
  scroll_box(width = "100%", height = "100%")
...
kable(levels(datos$Household.Head.Marital.Status)) %>%
  kable_styling() %>%
  scroll_box(width = "100%", height = "100%")
...
kable(summary(datos$Household.Head.Class.of.Worker)) %>%
  kable_styling() %>%
  scroll_box(width = "100%", height = "100%")
...
kable(levels(datos$Household.Head.Class.of.Worker)) %>%
  kable_styling() %>%
  scroll_box(width = "100%", height = "100%")
...
datos$Type.of.Household = 
  factor(datos$Type.of.Household,ordered=TRUE,levels=
           (c('Single Family'
              ...
              ,'Extended Family')))
kable(levels(datos$Type.of.Household)) %>%
  kable_styling() %>%
  scroll_box(width = "100%", height = "100%")
#---------------------------------------------------------------------------------------------------------------------------------------------
...
kable(levels(datos$Type.of.Building.House)) %>%
  kable_styling() %>%
  scroll_box(width = "100%", height = "100%")

#---------------------------------------------------------------------------------------------------------------------------------------------

kable(summary(datos$Type.of.Roof)) %>%
  kable_styling() %>%
  scroll_box(width = "100%", height = "100%")
...
kable(levels(datos$Type.of.Roof)) %>%
  kable_styling() %>%
  scroll_box(width = "100%", height = "100%")
...
kable(summary(datos$Type.of.Walls)) %>%
  kable_styling() %>%
  scroll_box(width = "100%", height = "100%")
...
kable(levels(datos$Type.of.Walls)) %>%
  kable_styling() %>%
  scroll_box(width = "100%", height = "100%")
#---------------------------------------------------------------------------------------------------------------------------------------------

kable(summary(datos$Toilet.Facilities)) %>%
  kable_styling() %>%
  scroll_box(width = "100%", height = "100%")
...
kable(levels(datos$Toilet.Facilities)) %>%
  kable_styling() %>%
  scroll_box(width = "100%", height = "100%")
#---------------------------------------------------------------------------------------------------------------------------------------------
kable(levels(datos$Household.Head.Occupation)) %>%
  kable_styling() %>%
  scroll_box(width = "100%", height = "100%")
#---------------------------------------------------------------------------------------------------------------------------------------------
kable(summary(datos$Main.Source.of.Water.Supply)) %>%
  kable_styling() %>%
  scroll_box(width = "100%", height = "100%")
...
kable(levels(datos$Main.Source.of.Water.Supply)) %>%
  kable_styling() %>%
  scroll_box(width = "100%", height = "100%")

#---------------------------------------------------------------------------------------------------------------------------------------------
kable(summary(datos$Tenure.Status)) %>%
  kable_styling() %>%
  scroll_box(width = "100%", height = "100%")
...
kable(levels(datos$Tenure.Status)) %>%
  kable_styling() %>%
  scroll_box(width = "100%", height = "100%")

#---------------------------------------------------------------------------------------------------------------------------------------------

kable(levels(datos$Electricity)) %>%
  kable_styling() %>%
  scroll_box(width = "100%", height = "100%")

kable(summary(datos$Electricity)) %>%
  kable_styling() %>%
  scroll_box(width = "100%", height = "100%")
...
```{r}
#---------------------------------------------------------------------------------------------------------------------------------------------
kable(summary(datos$Number.of.bedrooms)) %>%
  kable_styling() %>%
  scroll_box(width = "100%", height = "100%")

#---------------------------------------------------------------------------------------------------------------------------------------------
kable(summary(datos$Number.of.Refrigerator.Freezer)) %>%
  kable_styling() %>%
  scroll_box(width = "100%", height = "100%")

#---------------------------------------------------------------------------------------------------------------------------------------------
kable(summary(datos$Number.of.Washing.Machine)) %>%
  kable_styling() %>%
  scroll_box(width = "100%", height = "100%")

#---------------------------------------------------------------------------------------------------------------------------------------------
kable(summary(Number.of.Airconditioner)) %>%
  kable_styling() %>%
  scroll_box(width = "100%", height = "100%")

#---------------------------------------------------------------------------------------------------------------------------------------------
kable(summary(datos$Number.of.Car..Jeep..Van)) %>%
  kable_styling() %>%
  scroll_box(width = "100%", height = "100%")

#---------------------------------------------------------------------------------------------------------------------------------------------
kable(summary(datos$Number.of.CD.VCD.DVD)) %>%
  kable_styling() %>%
  scroll_box(width = "100%", height = "100%")

#---------------------------------------------------------------------------------------------------------------------------------------------
kable(summary(datos$Number.of.Cellular.phone)) %>%
  kable_styling() %>%
  scroll_box(width = "100%", height = "100%")

#---------------------------------------------------------------------------------------------------------------------------------------------
kable(summary(datos$Number.of.Component.Stereo.set)) %>%
  kable_styling() %>%
  scroll_box(width = "100%", height = "100%")

#---------------------------------------------------------------------------------------------------------------------------------------------
kable(summary(datos$Number.of.Landline.wireless.telephones)) %>%
  kable_styling() %>%
  scroll_box(width = "100%", height = "100%")

#---------------------------------------------------------------------------------------------------------------------------------------------
kable(summary(datos$Number.of.Personal.Computer)) %>%
  kable_styling() %>%
  scroll_box(width = "100%", height = "100%")

#---------------------------------------------------------------------------------------------------------------------------------------------
kable(summary(datos$Number.of.Motorcycle.Tricycle)) %>%
  kable_styling() %>%
  scroll_box(width = "100%", height = "100%")

#---------------------------------------------------------------------------------------------------------------------------------------------
kable(summary(datos$Number.of.Stove.with.Oven.Gas.Range)) %>%
  kable_styling() %>%
  scroll_box(width = "100%", height = "100%")

#---------------------------------------------------------------------------------------------------------------------------------------------
kable(summary(datos$Number.of.Television)) %>%
  kable_styling() %>%
  scroll_box(width = "100%", height = "100%")

#---------------------------------------------------------------------------------------------------------------------------------------------
kable(summary(datos$Number.of.Motorized.Banca)) %>%
  kable_styling() %>%
  scroll_box(width = "100%", height = "100%")
...
kable(summary(var_train_num$Total.Household.Income)) %>%
  kable_styling() %>%
  scroll_box(width = "100%", height = "100%")

kable(summary(var_train_num$Total.Food.Expenditure)) %>%
  kable_styling() %>%
  scroll_box(width = "100%", height = "100%")

kable(summary(var_train_num$Bread.and.Cereals.Expenditure)) %>%
  kable_styling() %>%
  scroll_box(width = "100%", height = "100%")

kable(summary(var_train_num$Total.Rice.Expenditure)) %>%
  kable_styling() %>%
  scroll_box(width = "100%", height = "100%")

kable(summary(var_train_num$Meat.Expenditure)) %>%
  kable_styling() %>%
  scroll_box(width = "100%", height = "100%")

kable(summary(var_train_num$Total.Fish.and..marine.products.Expenditure)) %>%
  kable_styling() %>%
  scroll_box(width = "100%", height = "100%")
...
kable(summary(var_train_num$Fruit.Expenditure)) %>%
  kable_styling() %>%
  scroll_box(width = "100%", height = "100%")

kable(summary(var_train_num$Vegetables.Expenditure)) %>%
  kable_styling() %>%
  scroll_box(width = "100%", height = "100%")

kable(summary(var_train_num$Restaurant.and.hotels.Expenditure)) %>%
  kable_styling() %>%
  scroll_box(width = "100%", height = "100%")

kable(summary(var_train_num$Alcoholic.Beverages.Expenditure)) %>%
  kable_styling() %>%
  scroll_box(width = "100%", height = "100%")

kable(summary(var_train_num$Tobacco.Expenditure)) %>%
  kable_styling() %>%
  scroll_box(width = "100%", height = "100%")

kable(summary(var_train_num$Clothing..Footwear.and.Other.Wear.Expenditure)) %>%
  kable_styling() %>%
  scroll_box(width = "100%", height = "100%")
...
kable(summary(var_train_num$Housing.and.water.Expenditure)) %>%
  kable_styling() %>%
  scroll_box(width = "100%", height = "100%")

kable(summary(var_train_num$Imputed.House.Rental.Value)) %>%
  kable_styling() %>%
  scroll_box(width = "100%", height = "100%")

kable(summary(var_train_num$Medical.Care.Expenditure)) %>%
  kable_styling() %>%
  scroll_box(width = "100%", height = "100%")

kable(summary(var_train_num$Transportation.Expenditure)) %>%
  kable_styling() %>%
  scroll_box(width = "100%", height = "100%")

kable(summary(var_train_num$Communication.Expenditure)) %>%
  kable_styling() %>%
  scroll_box(width = "100%", height = "100%")

kable(summary(var_train_num$Education.Expenditure)) %>%
  kable_styling() %>%
  scroll_box(width = "100%", height = "100%")
...
kable(summary(var_train_num$Miscellaneous.Goods.and.Services.Expenditure)) %>%
  kable_styling() %>%
  scroll_box(width = "100%", height = "100%")


kable(summary(var_train_num$Special.Occasions.Expenditure)) %>%
  kable_styling() %>%
  scroll_box(width = "100%", height = "100%")


kable(summary(var_train_num$Crop.Farming.and.Gardening.expenses)) %>%
  kable_styling() %>%
  scroll_box(width = "100%", height = "100%")


kable(summary(var_train_num$Total.Income.from.Entrepreneurial.Acitivites)) %>%
  kable_styling() %>%
  scroll_box(width = "100%", height = "100%")


kable(summary(var_train_num$Household.Head.Age)) %>%
  kable_styling() %>%
  scroll_box(width = "100%", height = "100%")


kable(summary(var_train_num$Total.Number.of.Family.members)) %>%
  kable_styling() %>%
  scroll_box(width = "100%", height = "100%")


#grid.arrange() COMENTO PARA QUE SE GENER EL HTML
...
kable(summary(datos_training$Total.Household.Income)) %>%
  kable_styling() %>%
  scroll_box(width = "100%", height = "100%")
...
# Se escogerán las que tengan una correlación > de 0.4 con respecto al "Total.Household.Income"
...
```
Los resultados que obtenemos son parcialmente buenos:

* El grádico de dispersión no es todo lo bueno que quisieramos, la forma de este gráfico nos informa que para cada valor predicho la varianza no es constante. Este gráfico también nos podría estar informando que el modelo de regresión lineal no es quizá el más adecuado para las variables que hemos seleccionado.

* Tenemos un R-squared de 0.6747 lo cual nos indica que con las variables elegidas estamos explicando casi el 70% de la varianza del Income (nuestra variable a predecir). 

* Las estimaciones de los betas tienen asociados un p-valor más pequeño que un nivel de significancia de 0.05 lo cual nos indica que es muy poco probable los betas estimados sean nulos. 

* El p-valor asociado al F-statistic es muy pequeño menor que el nivel de significancia 0.05 lo cual nos indica que el modelo es estadísticamente significativo y que nuestras variables elegidas explican algo de la variable a predecir
...
Si observamos el histograma y el gráfico Q-Q parece que nuestros residuos siguen una distribución normal. sin embargo, en nuestro test de normalidad obtenemos un p-valor muy pequeño cercano al nivel de significancia alpha = 0.05.
...
Vemos que el gráfico no varía mucho con respecto al mismo gráfico representado anteriormente utilizando el conjunto de training.
...
Valores_predichos<-10^(predichos)
...
Teniendo en cuenta que los valores de Income (predichos y reales) están en moneda filipina, y que la equivalencia a euros es: 1 peso filipino --> 0.018 euros. Si observamos el valor máximo y mínimo del valor absoluto de los residuos veremos que nuestro modelo llega a equivocarse en un máximo de 313226.72 que son: `r 313226.72 * 0.018` euros.
...
Llegados hasta este punto nos pareció interesante mostrar el gráfico Q-Q, histograma y test de normalidad para los resudios en unidades normales y en unidades logaritmicas obtenidos en la predicción
...
A lo largo del análisis, hemos descubierto cosas interesantes que nos han ayudado a definir un modelo de regresión lineal adecuado a nuestros datos:

* La población filipina es una *población generalmente pobre*. Eso conlleva a encontrarnos con muchos valores atípicos y problemas para definir un modelo integrando todos los elementos de nuestro data set

* Existen *dos o más comportmientos diferentes* dentro de un mismo data set. Esto significa, que para desarrollar un modelo lógico que prediga el income de una familia filipina, deberemos de diferenciar entre la familia filipina común (equivalente al 85% y mayoritariamente pobre) y la familia filipina de clase alta (aquella que genera valores atípicos y no es representativo)

* Al analizar a una población con tanto nivel de pobreza, debemos de entender que hay variables predictoras del income que en valores normales si tendrían sentido, pero en este tipo de datos no. Por ejemplo, variables como los gastos en ropa, comunicación, bienes de lujo cuentan con un alto porcentaje de 0. Trabajar con 0 no es el problema, sino entender que para este tipo de poblaciones, las cuales no gastan practicamente nada, existen otras variables mejores para predecir el income


La población filipina debe de tratarse como una población pobre, con variables predictoras del income algo diferentes a otro tipo de población con valores de income más repartido entre clases (que exista clase baja, media-baja, media, media alta y alta)